...
Ask your coding agent to read `SPEC.md` (and try its first acceptance scenario with your local Agent Relay:
...
Change the dashboard head
ing to `Agent Relay v2` and run the workflow again. Verify that the tests pass and the new heading appears in the deployed dashboard.
